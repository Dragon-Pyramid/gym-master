...
export default function UsuariosPage() {
  ...
  const handleDownloadPdf = async () => {
    try {
      await downloadCommercialReportPdf({
        ...
        fileName: locale === "en" ? "users-list-gym-master" : "listado-usuarios-gym-master",
        ...
        labels: {
          ...
          empty: c("No hay usuarios para mostrar.", "No users to display."),
        },columns: [
  ...
  const handleExportExcel = async () => {
    ...
    const worksheet = workbook.addWorksheet(c("Usuarios", "Users"));
    ...
    a.href = url;
    a.download = buildTimestampedDownloadFileName(locale === "en" ? "users-list" : "listado-usuarios", "xlsx");
    a.click();
