...
import { getEntrenadorById, updateEntrenador } from "@/services/entrenadorService";
...
export async function PUT(req: Request, {params} : {params: {id: string}}) {
    try {
       ...
       const entrenador = await updateEntrenador(id, updateData, user);
        ...
        return NextResponse.json({ message: "Entrenador actualizado correctamente", data: entrenador }, { status: 200 });
    } catch (error: any) {
