...
const PAGE_FILES: Record<string, string> = {
  ...
  "/dashboard/asistencias/terminal":
    "src/app/dashboard/asistencias/terminal/page.tsx",
  ...
  "/dashboard/compras": "src/app/dashboard/compras/page.tsx",
  ...
  "/dashboard/empleados": "src/app/dashboard/empleados/page.tsx",
...
const DYNAMIC_PAGE_FILES: Array<{ pattern: RegExp; file: string }> = [
  {
    pattern: new RegExp("^/dashboard/gestor-dietas/dieta/[^/]+/?$"),
    file: "src/app/dashboard/gestor-dietas/dieta/[idDieta]/page.tsx",
  },
  {
    pattern: new RegExp("^/dashboard/gestor-evolucion-fisica/socio/[^/]+/?$"),
    file: "src/app/dashboard/gestor-evolucion-fisica/socio/[socioId]/page.tsx",
  },
  {
    pattern: new RegExp("^/dashboard/gestor-rutinas/rutina/[^/]+/?$"),
    file: "src/app/dashboard/gestor-rutinas/rutina/[idRutina]/page.tsx",
  },
];
