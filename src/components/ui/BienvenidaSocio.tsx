  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-6 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-3xl">
        <div
          className={`overflow-hidden shadow-2xl rounded-2xl ${styles.panel}`}
        >
          <div className="flex flex-col items-center gap-6 p-8 md:flex-row md:p-12">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <h1
                className={`mt-4 text-4xl font-extrabold leading-tight md:text-5xl ${styles.title}`}
              >
                {title}
              </h1>

              <p className={`mt-3 text-lg font-medium ${styles.text}`}>
                {description}
              </p>
