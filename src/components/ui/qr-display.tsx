...
interface QrDisplayModalProps {
  ...
  embedded?: boolean; // cuando se muestra dentro de un layout propio (grid), sin Dialog
}
    ...
    <div className='flex flex-col w-full h-full'>
      <div className='px-6 pt-6 pb-4 space-y-3'>
        ...
        <p className='text-base text-center text-muted-foreground'>
          Escanea este código para acceder. Se actualiza automáticamente cada 10
          minutos.
        </p>
      </div>
      ...
      <div className='flex flex-row justify-center gap-3 px-6 pt-4 pb-6'>
        <Button
          variant='outline'
