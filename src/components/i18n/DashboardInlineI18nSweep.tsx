...
const EXACT_ONLY_TRANSLATIONS: Record<string, string> = {
  'No se pudo generar el PDF de socios': 'The member PDF could not be generated',
  '¿Está seguro de desactivar al socio?': 'Are you sure you want to deactivate this member?',
  '¿Está seguro de activar al socio?': 'Are you sure you want to activate this member?',
  'Error al actualizar estado del socio': 'Error updating member status',
  'Socio no seleccionado': 'No member selected',
  'No se pudo cargar el listado de socios para revisión.': 'The member list could not be loaded for review.',
  'Mi control médico': 'My medical check',
  'Mi ficha médica': 'My medical record',
  'Consultá tus datos vigentes, registrá una nueva actualización y revisá tu historial médico cargado en el gimnasio.': 'Review your current information, register a new update and check your medical history stored by the gym.',
  'Ir a rutinas': 'Go to routines',
  'Ir a dietas': 'Go to diets',
  'Ir a evolución física': 'Go to physical evolution',
  'Guía': 'Guidance',
  'Rutina detectada': 'Routine detected',
  'Dieta detectada': 'Diet detected',
  'Rutina + dieta': 'Routine + diet',
  'Orientación general': 'General guidance',
  'Necesita más datos': 'More information needed',
  'No se pudo obtener respuesta del Coach IA.': 'A response could not be obtained from the AI Coach.',
  'Ocurrió un error al consultar el Coach IA.': 'An error occurred while consulting the AI Coach.',
  'Reintentá en unos segundos o revisá los módulos de rutinas, dietas y evolución desde el menú.': 'Try again in a few seconds or review the routines, diets and evolution modules from the menu.',
  'Elegí una sugerencia o escribí tu consulta completa.': 'Choose a suggestion or enter your full question.',
  'Bíceps': 'Biceps',
  'Tríceps': 'Triceps',
  'Glúteos': 'Glutes',
  'No se pudieron cargar objetivos y niveles': 'Goals and levels could not be loaded',
  'Lumbalgia/dolor lumbar informado: evitar ejercicios de alto riesgo lumbar y priorizar variantes controladas.': 'Reported lower-back pain: avoid high-risk lumbar exercises and prioritize controlled variations.',
  'posible restricción física': 'possible physical restriction',
  'Tu navegador no soporta dictado por voz. Podés escribir el texto manualmente.': 'Your browser does not support voice dictation. You can enter the text manually.',
  'No se pudo usar el micrófono. Revisá los permisos del navegador.': 'The microphone could not be used. Check your browser permissions.',
  'El dictado se interrumpió. Podés continuar hablando o escribir manualmente.': 'Dictation was interrupted. You can continue speaking or type manually.',
  'No se pudo iniciar el dictado. Probá nuevamente o escribí el texto.': 'Dictation could not be started. Try again or enter the text.',
  'Dictado continuo activado. Podés hacer pausas y detenerlo cuando termines.': 'Continuous dictation enabled. You can pause while speaking and stop it when finished.',
  'Contale al asistente qué querés lograr antes de generar la rutina. Podés escribir o usar el micrófono.': 'Tell the assistant what you want to achieve before generating the routine. You can type or use the microphone.',
  'Primero contale al asistente qué querés lograr': 'First tell the assistant what you want to achieve',
  'cantidad de días': 'number of days',
  'Faltan algunos datos para interpretar bien tu pedido': 'Some information is missing to interpret your request correctly',
  'Revisá el resumen antes de generar la rutina': 'Review the summary before generating the routine',
  'No se pudo generar la rutina': 'The routine could not be generated',
  'Error al generar rutina': 'Error generating routine',
  'Mi alimentación': 'My nutrition',
  'Mis dietas': 'My diets',
  'Tené tu plan alimentario a mano desde el celular, comida por comida, con fechas claras y descarga PDF.': 'Keep your meal plan available on your phone, meal by meal, with clear dates and PDF download.',
  'Abrí una dieta para ver el detalle completo desde el celular.': 'Open a diet to view the full details from your phone.',
  'Sin día': 'No day',
  'Inscripción aprobada': 'Enrollment approved',
  'Asistencia registrada': 'Attendance recorded',
  'Sin cupo libre': 'No available slots',
  'Aplicá la migración privada para habilitar turnos, cupos e inscripciones.': 'Apply the private migration to enable shifts, capacity and enrollments.',
  'Error al eliminar actividad': 'Error deleting activity',
  'Turno actualizado correctamente': 'Shift updated successfully',
  'Turno creado correctamente': 'Shift created successfully',
  'Error al guardar turno': 'Error saving shift',
  'Turno eliminado correctamente': 'Shift deleted successfully',
  'Error al eliminar turno': 'Error deleting shift',
  'Socio inscripto correctamente': 'Member enrolled successfully',
  'Error al inscribir socio': 'Error enrolling member',
  'Inscripción actualizada': 'Enrollment updated',
  'Error al actualizar inscripción': 'Error updating enrollment',
  'El turno no tiene cupo disponible. Mantené al socio en lista de espera o aumentá el cupo del turno.': 'The shift has no available capacity. Keep the member on the waitlist or increase the shift capacity.',
  'Socio incorporado al turno': 'Member added to the shift',
  'Inscripción eliminada': 'Enrollment deleted',
  'Error al eliminar inscripción': 'Error deleting enrollment',
  'Tu usuario socio no tiene id_socio asociado. Contactá a administración.': 'Your member account has no associated member ID. Contact administration.',
  'Solicitud enviada a administración': 'Request sent to administration',
  'No se pudo enviar la solicitud': 'The request could not be sent',
  '¿Querés cancelar esta solicitud o inscripción?': 'Do you want to cancel this request or enrollment?',
  'Solicitud o inscripción cancelada correctamente': 'Request or enrollment canceled successfully',
  'No se pudo cancelar la inscripción': 'The enrollment could not be canceled',
  'Fecha inscripción': 'Enrollment date',
  'Según agenda cargada': 'According to the loaded schedule',
  'En revisión admin': 'Under admin review',
  'Buscar actividad, turno, instructor o ubicación...': 'Search activity, shift, instructor or location...',
  'Solicitar inscripción': 'Request enrollment',
  'Solicitar lista de espera': 'Request waitlist',
  'Sin turnos para graficar.': 'No shifts available to chart.',
  'Sin inscripciones para graficar.': 'No enrollments available to chart.',
  'Sin ocupación por actividad.': 'No occupancy data by activity.',
  'Requisitos, nivel, material necesario...': 'Requirements, level, required equipment...',
  'Sin instructor': 'No instructor',
  'Sin ubicación': 'No location',
  'Sin DNI': 'No ID',
  'Sin dato': 'No data',
  'Verificar turno': 'Review shift',
  'El turno no tiene cupo disponible': 'The shift has no available capacity',
  'Incorporar al socio al turno': 'Add member to the shift',
  'Buscar por nombre o DNI...': 'Search by name or ID...',
  'Error al cargar empleados': 'Error loading employees',
  'Fecha alta': 'Hire date',
  'Sin tipo': 'No type',
  'Base operativa de empleados del gimnasio, tipos, responsabilidades y preparación para sueldos/RBAC.': 'Operational employee base for the gym, types, responsibilities and payroll/RBAC preparation.',
  'No se pudo generar el PDF de empleados': 'The employee PDF could not be generated',
  'No se pudo desactivar empleado': 'The employee could not be deactivated',
  'Empleado desactivado correctamente': 'Employee deactivated successfully',
  'Error al desactivar empleado': 'Error deactivating employee',
  'Buscar empleado, DNI, tipo, área...': 'Search employee, ID, type or area...',
  'Error al cargar sueldos': 'Error loading salaries',
  'No se pudo anular el sueldo': 'The salary record could not be canceled',
  'Sueldo anulado': 'Salary record canceled',
  'No se pudo generar el PDF de asistencias': 'The attendance PDF could not be generated',
  'Asistencia eliminada correctamente': 'Attendance deleted successfully',
  'Error al eliminar asistencia': 'Error deleting attendance',
  'Salida registrada correctamente': 'Exit recorded successfully',
  'No se pudo registrar la salida': 'The exit could not be recorded',
