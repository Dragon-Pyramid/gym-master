...
const endpointDefinitions: EndpointDefinition[] = [
  ...
  },
  {
    ...
    "description": "Devuelve estado de cuota para socio autenticado, socio específico por query o resumen administrativo según rol. Para socios incluye estado_cuota, vencimiento_cuota, fecha_limite_pago con 7 días de gracia y monto_adeudado estimado desde la cuota vigente.",
    "auth": true,
    "admin": false,
    "notImplemented": false,
    "statuses": [
  ...
  },
  {
    ...
    "description": "Consulta el detalle de un servicio adicional por identificador, incluyendo categoría, modalidad, duración, reserva, cupo, disponibilidad online y estado. Implementación relacionada: getServicioById.",
    "auth": false,
    "admin": false,
    "notImplemented": false,
    "statuses": [
  ...
  },
  {
    ...
    "tag": "Ficha médica",
    "summary": "Ficha médica de socio",
    "description": "Crea ficha médica del socio mediante multipart/form-data. El campo ficha contiene el JSON de datos médicos y se aceptan archivos archivo_aprobacion y archivos_adjuntos en PDF, JPG o PNG para subirlos a Cloudinary. Requiere usuario autenticado. Implementación relacionada: createFichaMedicaSocio.",
    "auth": true,
    "admin": false,
    "notImplemented": false,
    "statuses": [
  ...
  },
  {
    ...
    "tag": "Usuarios",
    "summary": "Operaciones de usuarios",
    "description": "Consulta y administra usuarios como identidades de acceso. En altas con rol socio crea o vincula el perfil operativo en public.socio; en altas con rol usuario crea o vincula el perfil laboral en public.empleados. Mantiene contraseña inicial GymMaster + DNI, must_change_password y sincronización de activación/desactivación con perfiles asociados. Requiere usuario autenticado con permisos de administración. Implementación relacionada: createUsuarioServer, deactivateUsuarioServer, fetchUsuariosServer, updateUsuarioServer.",
    "auth": true,
    "admin": false,
    "notImplemented": false,
    "statuses": [
