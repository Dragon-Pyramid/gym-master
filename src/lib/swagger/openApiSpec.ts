...
const endpointDefinitions: EndpointDefinition[] = [
...

  {
    ...
    admin: false,
    notImplemented: false,
    statuses: [201, 400, 401, 403, 404, 500],
    queryParams: [],
...

  {
    ...
    description:
      "Devuelve KPIs, turnos, cupos, inscripciones, lista de espera y métricas operativas de actividades grupales. Para rol socio, limita datos personales a la inscripción propia y conserva turnos/cupos necesarios para solicitar inscripción.",
    auth: true,
    admin: false,
    notImplemented: false,
    statuses: [200, 401, 403, 500],
  ...
  },
  {
    ...
    description:
      "Inscribe un socio a un turno activo y lo deriva automáticamente a lista de espera cuando el cupo está completo. Para rol socio, fuerza la solicitud sobre su propio id_socio y registra la solicitud como pendiente/lista de espera para revisión administrativa.",
    auth: true,
    admin: false,
    notImplemented: false,
  ...
  },
  {
    ...
    description:
      "Permite a administración incorporar solicitudes en lista de espera al turno, marcar asistencia, ausencia, cancelación o eliminar una inscripción. Valida cupo disponible al aprobar y limita a los socios a cancelar su propia solicitud/inscripción.",
    auth: true,
    admin: false,
    notImplemented: false,
...

  {
    ...
    admin: false,
    notImplemented: false,
    statuses: [200, 201, 400, 401, 403, 413, 415, 500],
    queryParams: [],
...

  {
    ...
    admin: false,
    notImplemented: false,
    statuses: [200, 400, 401, 403, 404, 409, 413, 415, 500],
  ...
  },
  {
    ...
    description:
      "Devuelve el estado operativo de cuotas por socio, incluyendo al día, vencidos, sin pagos y próximos a vencer. Disponible para roles admin y usuario autorizados al módulo de BI de cuotas/pagos.",
    auth: true,
    admin: false,
    notImplemented: false,
    statuses: [200, 401, 403, 500],
  ...
  },
  {
    ...
    description:
      "Devuelve un resumen compacto para el dashboard: estados, pagos por método, vencidos, sin pagos y próximos a vencer. Disponible para roles admin y usuario autorizados al módulo de BI de cuotas/pagos.",
    auth: true,
    admin: false,
    notImplemented: false,
    statuses: [200, 401, 403, 500],
  ...
  },
  {
    ...
    admin: false,
    notImplemented: false,
    statuses: [200, 400, 401, 403, 413, 415, 500],
    queryParams: [],
  ...
  },
  {
    ...
    admin: false,
    notImplemented: false,
    statuses: [200, 201, 400, 401, 403, 404, 413, 415, 500],
    queryParams: [],
  ...
  },
  {
    ...
    admin: false,
    notImplemented: false,
    statuses: [200, 400, 401, 403, 404, 413, 415, 500],
    queryParams: [],
  ...
  {
    path: "/api/rutina/training-sessions",
    methods: ["GET", "POST"],
    tag: "Rutinas",
    ...
    notImplemented: false,
    statuses: [200, 201, 400, 401, 403, 404, 413, 415, 500],
    queryParams: ["rutinaId"],
    source: "src/app/api/rutina/training-sessions/route.ts",
  },
  {
    path: "/api/rutina/training-sessions/{id}",
    methods: ["PATCH"],
    tag: "Rutinas",
    ...
    statuses: [200, 400, 401, 403, 404, 409, 413, 415, 500],
    queryParams: [],
    source: "src/app/api/rutina/training-sessions/[id]/route.ts",
  },
  {
  ...
  },
  {
    ...
    admin: false,
    notImplemented: false,
    statuses: [201, 400, 401, 403, 404, 413, 500],
    queryParams: [],
  ...
  },
  {
    ...
    admin: true,
    notImplemented: false,
    statuses: [200, 201, 400, 401, 403, 409, 500],
    queryParams: [],
  ...
  },
  {
    ...
    admin: true,
    notImplemented: false,
    statuses: [200, 207, 400, 401, 403, 413, 415, 500],
    queryParams: [],
  ...
  },
  {
    ...
    admin: true,
    notImplemented: false,
    statuses: [200, 400, 401, 403, 413, 500],
    queryParams: [],
