...
export const RESPLADO_NEGOCIO_MODULES: ExportModuleDefinition[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'descripcion', label: 'Descripción', width: 36 },
      { key: 'precio', label: 'Precio', width: 16 },
      { key: 'duracion_minutos', label: 'Duración minutos', width: 18 },
      { key: 'requiere_reserva', label: 'Requiere reserva', width: 18 },
      { key: 'cupo_maximo', label: 'Cupo máximo', width: 14 },
      { key: 'modalidad', label: 'Modalidad', width: 16 },
      { key: 'disponible_online', label: 'Disponible online', width: 18 },
      { key: 'observaciones', label: 'Observaciones', width: 36 },
      { key: 'activo', label: 'Activo', width: 12 },
    ],
  },
