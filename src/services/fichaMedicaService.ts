...
export const createFichaMedicaSocio= async (user : JwtUser, id_socio: string, createFichaMedicaDto: CreateFichaMedicaDto, file: FileUploadDTO)=> {
...
export const FindAllUrlFotoFichaMedica = async (user: JwtUser, id_socio: string) => {
    const supabase = conexionBD(user.dbName);
