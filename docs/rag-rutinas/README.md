...
Esta carpeta documenta la preparación del dataset/corpus inicial para el futuro `gym-master-rag-coach`.
...
Este material es corpus/benchmark RAG. No debe confundirse con fine-tuning ni con entrenamiento directo del modelo.
